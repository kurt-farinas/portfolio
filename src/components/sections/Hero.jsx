    ...
    const onScroll = () => {
      if (!ticking) {
        window.requestAnimationFrame(() => {
          ...
          const titleBlur = isCompactViewport ? 0 : ease * 7;
          const titleLift = -(scrolled * 0.22);
          const titleScale = 1 - ease * 0.05;
          const splitFactor = ease * (isCompactViewport ? 10 : 26);
          ...
          if (subtitleRef.current) {
            ...
            const subBlur = isCompactViewport ? 0 : ease * 8;
          ...
          if (controlsRef.current) {
            ...
            const ctrlBlur = isCompactViewport ? 0 : ease * 5;
          ...
          if (bgWrapperRef.current) {
            ...
            const bgBlur = isCompactViewport ? 0 : ease * 9;
      ...
      <div ref={heroWrapRef} className="wrap hero-wrap">
        ...
        >
          <div className="hero-social-pill">
            ...
            <button type="button" onClick={copyEmail} aria-label="Copy email address" data-tooltip="Copy email">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <rect x="2" y="4" width="20" height="16" rx="2"></rect>
                <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"></path>
              </svg>
            </button>
            <button type="button" onClick={openResumeModal} aria-label="Preview Resume PDF" data-tooltip="View résumé">
